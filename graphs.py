...
val_accs = {"baseline_1": {"mean": [9.43396282196045, 9.562453269958496, 13.248123168945312, 16.31162452697754, 20.247514724731445, 28.64002227783203, 31.20308494567871, 33.97578811645508, 36.90403747558594, 35.477108001708984, 41.84756851196289, 37.51944351196289, 42.361534118652344, 44.620277404785156, 42.61851501464844, 32.75850296020508, 42.6388053894043, 42.54412841796875, 43.08514404296875, 43.96429443359375, 43.86961364746094, 43.2474479675293, 44.4444465637207, 44.27537536621094, 44.2280387878418, 44.4309196472168, 44.796104431152344, 45.0057487487793, 44.762290954589844, 44.85696792602539],
            ...
            "baseline_2": {"mean": [9.43396282196045, 9.562453269958496, 13.248123168945312, 16.31162452697754, 20.247514724731445, 28.64002227783203, 31.20308494567871, 33.97578811645508, 36.90403747558594, 35.477108001708984, 41.84756851196289, 37.51944351196289, 42.361534118652344, 44.620277404785156, 42.61851501464844, 32.75850296020508, 42.6388053894043, 42.54412841796875, 43.08514404296875, 43.96429443359375, 43.86961364746094, 43.2474479675293, 44.4444465637207, 44.27537536621094, 44.2280387878418, 44.4309196472168, 44.796104431152344, 45.0057487487793, 44.762290954589844, 44.85696792602539],
                         "abs_diff": [25.042264938354492, 33.854061126708984, 39.974300384521484, 39.724082946777344, 39.805233001708984, 46.006629943847656, 49.03631591796875, 45.4926643371582, 53.614662170410156, 53.2224235534668, 53.72286605834961, 48.7252311706543, 52.20125961303711, 51.673770904541016, 49.09041976928711, 51.36944580078125, 51.552040100097656, 53.263004302978516, 54.865760803222656, 55.880165100097656, 55.59613037109375, 57.1583137512207, 56.8539924621582, 56.8066520690918, 56.3467903137207, 56.90809631347656, 56.691688537597656, 56.779605865478516, 56.63082504272461, 56.745792388916016],
                         "rel_diff": [3.6450936794281006, 3.6045174598693848, 6.316359519958496, 3.692432403564453, 3.6383309364318848, 4.15229606628418, 6.221681118011475, 3.6383309364318848, 4.45661735534668, 3.6112799644470215, 5.038209438323975, 8.466896057128906, 9.92763900756836, 6.424561977386475, 4.267261981964111, 10.421316146850586, 43.1933479309082, 9.832961082458496, 42.260093688964844, 38.114559173583984, 28.890239715576172, 50.50381851196289, 32.048423767089844, 31.027254104614258, 56.089805603027344, 46.7302360534668, 58.8828010559082, 58.07804489135742, 60.073036193847656, 60.3367805480957]},
            "conv": {
...
def generate_accuracy_over_epochs_graph(model_types):
    ...
    for i, model in enumerate(model_types):
        ...
        axs[i].set_title(f"Validation set accuracy over the epochs for conv using formula {model[-1]}", fontsize=14, pad=20)
        axs[i].set_ylim([0,70])
...
def generate_combined_accuracy_graph(model_types):
    ...
    for model in model_types:
        ...
        line_style = '--' if model == 'baseline_1' or model == 'baseline_2' else '-'
...
if __name__ == "__main__":
    ...
    generate_combined_accuracy_graph(["baseline_2", "conv"])
    # generate_accuracy_over_epochs_graph(["baseline_1", "baseline_2"])
    # generate_accuracy_over_epochs_simple_graph("baseline_old")
